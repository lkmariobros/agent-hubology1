...
-- Drop and recreate RLS policies for property_transactions
DO $$
BEGIN
...
-- Drop and recreate RLS policies for commissions
DO $$
BEGIN
  -- Drop existing policies
...
-- Drop and recreate RLS policies for commission_installments
DO $$
BEGIN
  -- Drop existing policies
