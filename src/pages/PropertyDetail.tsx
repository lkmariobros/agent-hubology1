...
const PropertyDetail = () => {
  ...
  return <MainLayout>
      <div className="space-y-6 px-[17px] py-0">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          {!isLoading && property && <div className="flex space-x-2">
        ...
        {isLoading ? <PropertyDetailSkeleton /> : property ? <>
            {/* Property hero section */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2">
                <div className="relative rounded-lg overflow-hidden h-[300px] md:h-[400px] bg-muted">
                  {property.images && property.images.length > 0 ? <img src={property.images[0]} alt={property.title} className="w-full h-full object-cover" /> : <div className="w-full h-full flex items-center justify-center bg-secondary">
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="pt-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-4">
                      {property.size && <div className="flex items-center space-x-2">
                      ...
                      {property.bedrooms && <div className="flex items-center space-x-2">
                          <div className="h-8 w-8 rounded-md bg-secondary flex items-center justify-center">
                      ...
                      {property.bathrooms && <div className="flex items-center space-x-2">
                          <div className="h-8 w-8 rounded-md bg-secondary flex items-center justify-center">
                  ...
                  <CardContent className="p-6">
                    {property.features && property.features.length > 0 ? <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                          {property.features.map((feature, index) => <div key={index} className="flex items-center space-x-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 mt-6">
            {[1, 2, 3, 4].map(i => <div key={i} className="flex items-center space-x-2">
