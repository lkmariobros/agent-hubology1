                ...
                <div className="h-[400px]">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    bottom: 5
                      ...
                      <Legend />
                      <Line type="monotone" dataKey="value" name="Sales" stroke="#8b5cf6" activeDot={{
                      r: 8
                    }} strokeWidth={2} />
                    </LineChart>
                  </ResponsiveContainer>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="h-[250px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        <Pie data={propertyTypeData} cx="50%" cy="50%" labelLine={false} outerRadius={80} fill="#8884d8" dataKey="value" label={({
                        name,
                        percent
