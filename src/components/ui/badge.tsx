  ...
  "inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: "text-foreground border border-[rgba(255,255,255,0.2)]",
        success:
        ...
        active:
          "border-transparent bg-emerald-500 text-white hover:bg-emerald-600",
        inactive:
          "border-transparent bg-[rgba(255,255,255,0.1)] text-[rgba(255,255,255,0.8)] hover:bg-[rgba(255,255,255,0.15)]",
      },
    },
    defaultVariants: {
      variant: "default",
