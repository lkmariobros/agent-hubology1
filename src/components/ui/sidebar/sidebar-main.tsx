        ...
        >
          ...
          <div
            className={cn(
              ...
              variant === "floating" || variant === "inset"
                ? "group-data-[state=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]"
          ...
          <div
            className={cn(
              ...
              variant === "floating" || variant === "inset"
                ? "p-2 group-data-[state=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+2px)]"
                : "group-data-[state=icon]:w-[--sidebar-width-icon] group-data-[side=left]:border-r group-data-[side=right]:border-l",
              className
            )}
            {...props}
          >
