...
// Define opportunity board props
...
const OpportunitiesBoard: React.FC<OpportunitiesBoardProps> = ({
  ...
  // Sample opportunities data (fallback if API call fails)
  ...
  const opportunities = opportunitiesData?.data || sampleOpportunities;
  
  // Filter opportunities based on selected tab
  const filteredOpportunities = activeTab === 'All' 
    ? opportunities 
    : opportunities.filter(opp => opp.propertyType === activeTab);
        ...
        <Tabs defaultValue="All" value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value={activeTab} className="mt-0">
            ...
            <div className="flex justify-center mt-6">
              <Button variant="outline" size="sm" className="gap-2" onClick={onViewAll} asChild={!!onViewAll}>
                {onViewAll ? (
